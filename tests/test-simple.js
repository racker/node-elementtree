...
exports['test_write_with_options'] = function(test, assert) {
    ...
    var se1 = SubElement(e, "blah", {
        a: 11
    });
    var se2 = SubElement(se1, "baz", {
        d: 11
    });
    se2.text = 'test';
    SubElement(e, "blah", {
    ...
    assert.equal(i, 1);
    var etree = new ElementTree(e);
    var xml1 = etree.write({
        'indent': 4
    });
    var xml2 = etree.write({
        'indent': 2
    });
...
exports['test_register_namespace'] = function(test, assert) {
    ...
    assert.equal(et.tostring(etree, {
...
exports['test_tostring'] = function(test, assert) {
    ...
    assert.equal(et.tostring(a, {
        'xml_declaration': false
    }), '<a><b /><c>543</c></a>');
    assert.equal(et.tostring(c, {
        'xml_declaration': false
    }), '<c>543</c>');
    test.finish();
};
